...
const CACHE_VERSION = 'jobsystems-v30';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './app-part-01.js?v=20260829-1',
  './app-part-02.js?v=20260829-1',
  ...
  './productivity-command-center.css?v=20260831-2',
  ...
  './productivity-command-center.js?v=20260831-2',
];
